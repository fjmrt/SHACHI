...
class APump():
    def __init__(self,
        ...
        self.flip_flow_direction = parameters.get("flip_flow_direction", True)
    ...
    def getStatus(self):
        ...
        if self.flip_flow_direction:
            ...
            direction = {" ": "Not Running", "+": "Reverse", "-": "Reverse"}.\
                    get(message[0], "Unknown")
    ...
    def setFlowDirection(self, Reverse):
        if self.flip_flow_direction:
            if Reverse:
    ...
    def startFlow(self, speed, direction = "Reverse"):
        self.setSpeed(speed)
        self.setFlowDirection(direction == "Reverse")
